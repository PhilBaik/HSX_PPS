...
MODEL               = DCM_3
MODULES             = rt_matrx.c rt_printf.c rt_logging.c DCM_3.c DCM_3_capi.c DCM_3_data.c DCM_3_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
MAKEFILE            = DCM_3.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/Sy2/AppData/Local/Temp/Temp1_model_DC_motor.zip
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = DCM_3_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/DCM_3 \
...
sfun_spid_contc.obj : C:\Program\ Files\MATLAB\R2019b\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019b\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
